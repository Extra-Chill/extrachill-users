...
function send_welcome_email_to_new_user($user_id) {
    ...
    $message .= "<a href='" . esc_url( ec_get_site_url( 'community' ) ) . "'>Community Forums</a><br>";
    $message .= "<a href='" . esc_url( $main_site_url ) . "'>Extra Chill Magazine</a><br>";
    $message .= "<a href='" . esc_url( $main_site_url ) . "/festival-wire/'>Festival Wire</a><br>";
    $message .= "<a href='" . esc_url( ec_get_site_url( 'artist' ) ) . "'>Artist Platform</a><br>";
    $message .= "<a href='" . esc_url( ec_get_site_url( 'shop' ) ) . "'>Shop</a><br>";
    $message .= "<a href='" . esc_url( ec_get_site_url( 'chat' ) ) . "'>AI Chat</a><br>";

...
function auth_fuzz_registration( array $overrides ): array {
	return array_merge( array(
		...
		'device_name'         => 'Auth Fuzz',
		'set_cookie'          => false,
		'registration_source' => 'auth-fuzz',
...
foreach ( array( $existing->user_login, $existing->user_email ) as $identifier ) {
	$login = auth_fuzz_rest( '/extrachill/v1/auth/login', array(
...
$unknown_login = auth_fuzz_rest( '/extrachill/v1/auth/login', array(
	'identifier' => 'missing-auth-fuzz',
	'password'   => 'wrong-pass',
	'device_id'  => '00000000-0000-4000-8000-000000000252',
) );
$known_login   = auth_fuzz_rest( '/extrachill/v1/auth/login', array(
...
$nonmember_login = auth_fuzz_rest( '/extrachill/v1/auth/login', array(
...
$blocked_login = auth_fuzz_rest( '/extrachill/v1/auth/login', array(
...
$consumer_site_id  = (int) get_sites( array(
	'number'       => 1,
...
$token_login    = auth_fuzz_rest( '/extrachill/v1/auth/login', array(
	'identifier' => $existing->user_login,
	'password'   => 'existing-pass-248',
...
$wrong_device_refresh = auth_fuzz_rest( '/extrachill/v1/auth/refresh', array(
...
$rotated        = auth_fuzz_rest( '/extrachill/v1/auth/refresh', array(
	'refresh_token' => $first_refresh,
	'device_id'     => $refresh_device,
) );
...
$replay = auth_fuzz_rest( '/extrachill/v1/auth/refresh', array(
	'refresh_token' => $first_refresh,
	'device_id'     => $refresh_device,
) );
...
delete_transient( 'wp_native_auth_refresh_' . md5( $refresh_device ) );
$burned_family = auth_fuzz_rest( '/extrachill/v1/auth/refresh', array(
...
$expired_login  = auth_fuzz_rest( '/extrachill/v1/auth/login', array(
	'identifier' => $existing->user_login,
	'password'   => 'existing-pass-248',
...
$expired = auth_fuzz_rest( '/extrachill/v1/auth/refresh', array(
...
$victim_login      = auth_fuzz_rest( '/extrachill/v1/auth/login', array(
...
$victim_refresh = auth_fuzz_rest( '/extrachill/v1/auth/refresh', array(
...
$cross_user_onboarding = auth_fuzz_rest( '/extrachill/v1/users/onboarding', array(
	'user_id'  => (int) $existing->ID,
	'username' => 'isolated_auth_fuzz',
), (int) $onboarding->ID );
...
for ( $attempt = 0; $attempt < 5; ++$attempt ) {
	$failed = auth_fuzz_rest( '/extrachill/v1/auth/login', array(
		'identifier' => $existing->user_login,
		'password'   => 'wrong-pass',
...
$alias_bypass = auth_fuzz_rest( '/extrachill/v1/auth/login', array(
